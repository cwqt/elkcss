...
gulp.task('image', function () {
	return gulp.src(['./src/assets/*']).pipe(gulp.dest('./dist/assets/img/'));
})
...
gulp.task('watch', function() {
	...
	gulp.watch(['src/sass/*.scss', 'src/sass/**/*.scss'], ['style']);
	gulp.watch(['src/js/*.js'], ['script-watch']);
});

gulp.task('default',['templates','style','script', 'image', 'browser-sync','watch']);

gulp.task('build',['templates','style','script', 'image']);
